package backend.platform.windows;
...
extern class WinAPI
{
  ...
  /**
   * Removes as many pages as possible from the process working set, making memory freed by the garbage collector visible in Task Manager immediately.
   */
  @:native('WINAPI_EmptyWorkingSet')
  static function emptyWorkingSet():Void;
  ...
  /**
	 * Clears or opens the command line console (CMD).
	 * https://stackoverflow.com/questions/15543571/allocconsole-not-displaying-cout
	 */
  @:native('WINAPI_AllocConsole')
  static inline function allocConsole():Void { }

	/**
	 * Clears the command line console (CMD).
	 */
  @:native('WINAPI_ClearScreen')
	static inline function clearScreen():Void { }
}
#end
