...
/**
 * Removes as many pages as possible from the process working set, so memory freed by the garbage collector becomes visible in Task Manager immediately.
 */
void WINAPI_EmptyWorkingSet();
